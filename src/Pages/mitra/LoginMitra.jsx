...
const LoginMitra = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.user.role !== 'mitra') {
                setError('Akun ini bukan akun Mitra. Gunakan halaman login yang sesuai.');
                return;
            }
            ...
            <main className="flex-1 flex items-center justify-center p-8">
                <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-10 flex flex-col items-center w-full max-w-md border border-white/20 shadow-xl">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        <Handshake size={24} className="text-green-800" />
                        <h2 className="text-2xl font-bold text-green-800 font-graduate uppercase">LOGIN MITRA</h2>
                    </div>
                    <p className="text-green-700/80 font-medium mb-8 text-center text-sm">
                        Gunakan akun yang terdaftar di sistem PKS TNGM
                    </p>
