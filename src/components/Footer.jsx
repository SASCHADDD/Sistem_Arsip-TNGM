...
const Footer = () => {
    return (
        <footer className="w-full text-white py-12 mt-auto bg-[#0F3D17] border-t-4 border-[#D4BB76]">
            <div className="container mx-auto px-4 flex flex-col items-center text-center space-y-6">
                <div>
                    ...
                    <p className="max-w-2xl mx-auto text-green-100 font-medium leading-relaxed">
