...
import { LayoutDashboard, Upload, History, Menu, LogOut } from 'lucide-react';
        ...
        <div className="drawer lg:drawer-open font-sans bg-transparent">
            ...
            <div className="drawer-side z-20">
                ...
                >
                    ...
                    {/* Divider */}
                    <div className="h-px bg-gray-900/20 mx-6 mb-6"></div>

                    {/* User Profile Section */}
                    <div className="px-6 mb-8">
                        <p className="font-semibold text-green-900 line-clamp-1" title={JSON.parse(localStorage.getItem('user'))?.nama || 'Pegawai TNGM'}>
                            {JSON.parse(localStorage.getItem('user'))?.nama || 'Pegawai TNGM'}
                        </p>
                        <p className="text-xs text-green-800">User Internal</p>
                    </div>
